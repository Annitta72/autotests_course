...
def treatment_sum(our_tuple):
    """
    Функция, которая складывает 2 элемента из кортежа, с условием, что в кортеже все 2 элемента и их можно сложить,
    если условия не выполняются, срабатывают исключения

    :param our_tuple: входной кортеж

    :return: результирующее число - сумма 2 элементов
    """
    if len(our_tuple) == 2:
        try:
