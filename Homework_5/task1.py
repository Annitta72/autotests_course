...
def letter_stat(our_str):
    """
    Функция, которая возвращает словарь, где в качестве ключей буквы строки,
    а значениями являются числа, соответствующие количеству вхождений данной буквы в строку.
    Args:
        our_str (str): входная строка

    Returns:
        dict: словарь с результатом (ключ - буква из списка, значение - кол-во вхождений в строку)
    """
