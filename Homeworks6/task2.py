...
def global_function():
    """
    Функция, которая возвращает глобальную переменную с новым значением
    ...
    def local_function():
        """
        Функция, которая изменяет и возвращает новое значение из объемлющей области видимости
